            ...
            <main className="grid gap-12 px-6 py-16 lg:grid-cols-2 lg:gap-20">
                <div>
                    ...
                    <p className="mt-6 max-w-prose text-lg leading-relaxed text-muted text-pretty">
                        Tell us the face, the market, and the first video. We will come back with a
                        studio seat — not a 40-slide deck.
                    </p>
                </div>

                {sent ? (
                    <div className="border-2 border-line p-8">
                        <p className="font-display text-4xl font-extrabold uppercase tracking-[-0.04em]">
                            Received.
                        </p>
                        <p className="mt-4 max-w-prose text-muted">
                            The brief is with the studio. A producer will follow up at the email you
                            left.
                        </p>
                        <Link
                            to="/"
                            className="mt-8 inline-flex min-h-12 items-center bg-fg px-5 font-display text-[13px] font-bold uppercase tracking-[0.06em] text-bg"
                        >
                    ...
                    <form
                        onSubmit={onSubmit}
                        className="relative flex flex-col gap-5 border-2 border-line p-6 sm:p-8"
                    >
                        <input
                            type="text"
