...
function Home() {
    return (
        <div className="min-h-screen overflow-x-hidden bg-bg text-fg">
            ...
            <section
                id="contexts"
                className="scroll-mt-8 border-t-2 border-line px-6 py-16 md:py-20"
            >
                <div className="mx-auto mb-10 max-w-3xl text-center">
                    <p className="text-[11px] uppercase tracking-[0.22em] text-muted">
                        One avatar, every vertical
                    </p>
                    ...
                    <p className="mx-auto mt-5 max-w-prose text-muted text-pretty">
                        The same identity, recut for the industry in front of it. Social content,
                        online courses, legal, finance, real estate — new set, wardrobe, and
                        caption. No recast. Native 9:16 for TikTok, Reels, and Stories.
                    </p>
                </div>
                <ReelRow />
            </section>
            ...
            <section className="grid border-b-2 border-line lg:grid-cols-2">
                ...
                <div className="flex flex-col justify-center px-6 py-12 lg:px-12">
                    ...
                    <p className="mt-6 max-w-prose text-lg leading-relaxed text-muted text-pretty">
                        Be everywhere without being everywhere. INFLUENTIAL LABS keeps the same
                        face, the same micro-expressions, the same presence — in a 30-second clip
                        and a 10-minute course module. No drift. No artifacts. No uncanny valley.
                    </p>
                    ...
                    <p className="mt-3 text-[11px] uppercase tracking-[0.16em] text-muted">
                        Built and delivered by our studio.
                    </p>
                </div>
            </section>
                ...
                {pillars.map((p) => (
                    ...
                    >
                        ...
                        <div className="px-5 py-6">
                            <span className="font-display text-4xl font-extrabold tracking-[-0.06em] text-spot">
                                {p.n}
                            </span>
                            <h3 className="mt-2 font-display text-lg font-bold uppercase tracking-[-0.03em]">
                                {p.name}
                            </h3>
                            <p className="mt-3 text-sm leading-relaxed text-muted group-hover:hidden">
                                {p.lede}
                            </p>
                            <p className="mt-3 hidden text-sm leading-relaxed text-fg group-hover:block">
                                {p.detail}
                            </p>
                        </div>
                    </a>
            ...
            <Split
                ...
                reverse={false}
            >
                We keep a single, coherent identity across every video we make for you. The same
                face, the same micro-expressions, the same presence — whether the cut is thirty
                seconds or a ten-minute lesson.
            </Split>
            <FeatureStrip
                items={[
                    {
                        ...
                        detail: "Avatar V-grade lock: the same face, micro-expressions, and presence in a 30-second clip and a 10-minute module. No drift. No artifacts. No uncanny valley. Trained on how you talk and move — not a one-frame mask.",
                        image: "/talent/mara.jpg",
                    },
                    {
                        t: "Multiple angles",
                        d: "Wide, medium, close-up — from one recording.",
                        detail: "The camera language of a real production: wides, mediums, and close-ups that still read as one person.",
                        image: "/product/angles.jpg",
                    },
                    {
                        t: "Phoneme-level lip sync",
                        d: "What you hear and what you see agree.",
                        detail: "Phoneme accuracy at any speed, in 175+ languages and dialects. What you hear and what you see are in perfect agreement. The mouth is not guessing.",
                        image: "/product/lips.jpg",
                    },
                    {
                        t: "Voice-synced emotion",
                        d: "A performer, not a slide.",
                        detail: "Upper-body motion, gesture, and stillness hold across scene changes — driven by the voice, not a loop.",
            ...
            <Split
                ...
                reverse
            >
                Brief us the idea. We return a share-ready video faster than you'd expect. No
                camera, editing software, or production skills needed. Visuals, avatar, B-roll, and
                motion graphics land in one pass.
            </Split>
            <FeatureStrip
                items={[
                    {
                    ...
                    },
                    {
                        ...
                        detail: "Every motion element stays editable after generate. Adjust text, color, timing, or layout in Studio without rendering the video again from scratch.",
            ...
            <Split
                ...
                reverse={false}
            >
                The central document is a script. You set the tone, pace, gesture and emotion, our
                team directs the take. Comments, tags, and a Brand Kit sit beside the page so teams
                mark up a take the way they mark up copy.
            </Split>
            <FeatureStrip
                items={[
                    {
            ...
            <Split
                ...
                reverse
            >
                AI video translation that keeps your tone, locks your lips, and reaches global
                audiences in 175+ languages and dialects — no reshoot, no manual dub.
            </Split>
            <LangBar />
            <FeatureStrip
                items={[
            ...
            <section id="self-serve" className="scroll-mt-8 border-t-2 border-line">
                <div className="grid lg:grid-cols-2">
                    ...
                    <div className="flex flex-col justify-center px-6 py-12 lg:px-12">
                        ...
                        <p className="mt-6 max-w-prose text-lg leading-relaxed text-muted text-pretty">
                            Don't brief the agency. Sit at the desk. Image edit, image-to-video,
                            long scenes, talking video — one coin balance, review before you pay.
                            Fifty coins on signup. No subscription. You make it. You ship it.
                        </p>
                        <div className="mt-8 flex flex-wrap gap-3">
                            <a
                                href={STUDIO_URL}
                                className={cn(buttonVariants({ variant: "heat" }))}
                            >
                                Open the studio
                            </a>
                            <Link to="/start" className={cn(buttonVariants({ variant: "ghost" }))}>
                ...
                <ul className="grid border-t-2 border-line sm:grid-cols-2 lg:grid-cols-4">
                    {selfServe.map((item) => (
                        ...
                        >
                            <span className="font-display text-2xl font-extrabold tracking-[-0.06em] text-spot">
                                {item.n}
                            </span>
            ...
            <section id="tools" className="scroll-mt-8 border-t-2 border-line px-6 py-16 md:py-24">
                ...
                <p className="mt-5 max-w-prose text-muted text-pretty">
                    Each card is an entry point — not a separate product. It jumps to the pillar
                    that does that job, so you can start from a script, a still, a face, or a
                    finished film.
                </p>
                        ...
                        <li key={tool.name} className="bg-bg">
                            ...
                            >
                                <div>
                                    ...
                                    <p className="mt-3 text-sm leading-relaxed text-muted group-hover:text-fg">
                                        {tool.blurb}
                                    </p>
                                </div>
            ...
            <section id="how" className="scroll-mt-8 border-t-2 border-line">
                <div className="px-6 pt-16 md:pt-20">
                    ...
                    <p className="mt-5 mb-10 max-w-prose text-muted text-pretty">
                        The order is the product. Lock the identity first, write the performance
                        second, localize last. Skip a step and the face drifts or the market gets a
                        recast.
                    </p>
                </div>
            ...
            <section id="trust" className="scroll-mt-8 border-t-2 border-line">
                <div className="px-6 pt-16 md:pt-20">
                    ...
                    <p className="mt-5 mb-10 max-w-prose text-muted text-pretty">
                        AI video has a consent problem. INFLUENTIAL LABS treats likeness, brand
                        language, and the edit as things you keep — not a model we train on in the
                        dark.
                    </p>
                </div>
                <div className="grid border-t-2 border-line md:grid-cols-3">
            ...
            <section className="grid border-t-2 border-line lg:grid-cols-2">
                <div className="flex flex-col justify-end px-6 py-16 md:py-20">
                    ...
                    <Link
                        to="/start"
                        className={cn(
                            buttonVariants({ variant: "spot" }),
                            "mt-8 w-fit min-h-14 px-8",
                        )}
                    >
                        Start a project
                    </Link>
                ...
                <figure className="min-h-72 overflow-hidden lg:min-h-[28rem]">
                    <img
                        src="/talent/sable.jpg"
                        alt="INFLUENTIAL LABS talent"
                ...
                {locales.map((l) => (
                    <button
                        ...
                        className={cn(
                            ...
                            l.id === id
                                ? "border-heat bg-heat text-heat-fg"
...
function Ethics({ t, d }: { t: string; d: string }) {
    return (
        <div className="group border-b-2 border-line px-6 py-10 transition-colors duration-200 hover:bg-heat/10 md:border-b-0 md:border-r-2 md:last:border-r-0">
            ...
            <p className="mt-3 max-w-prose text-sm leading-relaxed text-muted group-hover:text-fg">
                {d}
            </p>
        </div>
    );
...
function HeroShots() {
    const shots = [
        {
            src: "/talent/sable.jpg",
            video: "/loops/sable.mp4",
            alt: "INFLUENTIAL LABS avatar, fashion",
        },
        {
            src: "/talent/ash.jpg",
            video: "/loops/ash.mp4",
            alt: "INFLUENTIAL LABS avatar, editorial",
        },
        {
            src: "/talent/lina.jpg",
            video: "/loops/lina.mp4",
            alt: "INFLUENTIAL LABS avatar, lifestyle",
        },
        {
            src: "/talent/kai.jpg",
            video: "/loops/kai.mp4",
            alt: "INFLUENTIAL LABS avatar, campaign",
        },
    ] as const;
...
function Split({
    ...
    return (
        <section id={id} className="scroll-mt-8 grid border-t-2 border-line lg:grid-cols-2">
            ...
            <div
                className={cn(
                    "flex flex-col justify-center px-6 py-12 lg:px-12",
                    reverse && "lg:order-1",
                )}
            >
                <p className="text-[11px] uppercase tracking-[0.22em] text-muted">
        ...
        <ul className="grid sm:grid-cols-2 lg:grid-cols-4">
            {items.map((item) => {
                ...
                return (
                    <li
                        key={item.t}
                        className="min-h-0 border-t-2 border-r-2 border-line last:border-r-0 max-lg:[&:nth-child(2n)]:border-r-0 lg:[&:nth-child(4n)]:border-r-0"
                    >
                        <button
                            type="button"
                            ...
                            className={cn(
                                ...
                                on
                                    ? "bg-heat/10 outline outline-2 outline-heat -outline-offset-2"
                                    : "hover:bg-heat/10 hover:outline hover:outline-2 hover:outline-heat hover:-outline-offset-2",
                            )}
                        >
                            ...
                            <div className="flex flex-1 flex-col px-5 py-6">
                                ...
                                <p
                                    className={cn(
                                        ...
                                        on ? "hidden" : "text-muted group-hover:hidden",
                                    )}
                                >
                                    {item.d}
                                </p>
                                <p
                                    className={cn(
                                        "mt-3 text-sm leading-relaxed text-fg",
                                        on ? "block" : "hidden group-hover:block",
                                    )}
                                >
                                    {item.detail}
                                </p>
...
function Step({
    ...
    return (
        ...
        >
            ...
            <p className="mt-3 hidden max-w-prose text-sm leading-relaxed text-fg group-hover:block">
                {detail}
            </p>
            <span className="mt-6 text-[11px] uppercase tracking-[0.16em] text-muted group-hover:text-heat">
                Jump to this step →
